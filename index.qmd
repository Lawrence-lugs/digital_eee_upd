...
```{=html}
<!-- ─── HERO ──────────────────────────────────────────────────────────────── -->
<section class="hero text-gray-900 py-28 px-8 text-center">
  ...
  <div class="max-w-5xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
      ...
      <a href="verilog"
        ...
        <p class="text-sm text-gray-500 leading-relaxed">
          Free-play Verilog environment — write, simulate, and experiment
          with HDL code directly in your browser.
        </p>
      </a>
      
      
      <!-- Timing Simulator -->
      <a href="timing_simulatEEE.html"
         class="block bg-white rounded-xl border border-gray-200 p-6
                hover:shadow-md hover:border-red-300 transition-all group">
        <div class="w-10 h-10 rounded-lg flex items-center justify-center mb-4"
             style="background: #fee2e2;">
      ...
      <a href="ASM_simulatEEE.html"
        ...
        <p class="text-sm text-gray-500 leading-relaxed">
          Simulate ASM charts with interactive execution and visualization of
          state transitions, conditions, and outputs.
        </p>
      </a>

      <!-- RV32I Encoding Simulator -->
      <a href="RV32I_encoding_simulator.html"
         class="block bg-white rounded-xl border border-gray-200 p-6
                hover:shadow-md hover:border-red-300 transition-all group">
        <div class="w-10 h-10 rounded-lg flex items-center justify-center mb-4"
             style="background: #fee2e2;">
          <svg class="w-5 h-5" style="color: #7B0D1E;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M8 9h8M8 15h8M5 6v12m14-12v12M3 9h4m10 0h4M3 15h4m10 0h4"/>
          </svg>
        </div>
        <h3 class="font-bold text-gray-900 mb-2 group-hover:text-red-800 transition-colors">
          RV32I Encoding Simulator
        ...
        <p class="text-sm text-gray-500 leading-relaxed">
          Assemble and inspect RISC-V RV32I instructions, including their
          encoded fields, binary representation, and hexadecimal output.
        </p>
      </a>

      <!-- Systolic Array Simulator -->
      <a href="systolic_array_simulator.html"
         class="block bg-white rounded-xl border border-gray-200 p-6
                hover:shadow-md hover:border-red-300 transition-all group">
        <div class="w-10 h-10 rounded-lg flex items-center justify-center mb-4"
             style="background: #fee2e2;">
          <svg class="w-5 h-5" style="color: #7B0D1E;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM14 14h6v6h-6zM10 7h4M10 17h4M7 10v4M17 10v4"/>
          </svg>
        </div>
        <h3 class="font-bold text-gray-900 mb-2 group-hover:text-red-800 transition-colors">
          Systolic Array Simulator
        ...
        <p class="text-sm text-gray-500 leading-relaxed">
          Step through an output-stationary systolic array cycle by cycle
          and visualize data flow and accumulation.
        </p>
      </a>

      <!-- Address Generator for Systolic Arrays -->
      <a href="address_generator_simulator.html"
         class="block bg-white rounded-xl border border-gray-200 p-6
                hover:shadow-md hover:border-red-300 transition-all group">
        <div class="w-10 h-10 rounded-lg flex items-center justify-center mb-4"
             style="background: #fee2e2;">
          <svg class="w-5 h-5" style="color: #7B0D1E;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M3 4h6v6H3zM3 14h6v6H3zM15 7h6v10h-6zM9 7h6M9 17h6M12 7v10"/>
          </svg>
        </div>
        <h3 class="font-bold text-gray-900 mb-2 group-hover:text-red-800 transition-colors">
          Address Generator for Systolic Arrays
        ...
        <p class="text-sm text-gray-500 leading-relaxed">
          Explore how feature and filter addresses feed a systolic array,
          and follow data movement cycle by cycle.
        </p>
      </a>
...
<footer class="py-10 px-8 border-t border-gray-200">
  <div class="max-w-5xl mx-auto text-center text-sm text-gray-400">
    <p>Digital Design Group | Electrical and Electronics Engineering Institute</p>
    <p class="mt-1">University of the Philippines Diliman</p>
    <p class="mt-3 text-xs">Note: The above hero header image is AI generated. For inquiries, please contact <a href="mailto:adelson.chua@eee.upd.edu.ph">
    adelson.chua@eee.upd.edu.ph
    </a>
    .
    </p>
