...
![assign](./Course_ Verilog Crash Course_files/assign.png){width=45%}       ![always](./Course_ Verilog Crash Course_files/always.png){width=45%}
...
![concurrent_blocks](./Course_ Verilog Crash Course_files/concurrent_blocks.png){width=70%}
...
![separate_always_blocks](./Course_ Verilog Crash Course_files/separate_always_blocks.png){width=70%}
...
![conditional_if](./Course_ Verilog Crash Course_files/conditional_if.png){width=35%}
...
![conditional_case](./Course_ Verilog Crash Course_files/conditional_case.png){width=35%}
...
![loop](./Course_ Verilog Crash Course_files/combinational_loop.png){width=45%}
...
![latch_soln_default](./Course_ Verilog Crash Course_files/latch_soln_default.png){width=35%}
...
![double_driver_ex2](./Course_ Verilog Crash Course_files/double_driver_ex2.png){width=60%}
...
![double_driver_soln](./Course_ Verilog Crash Course_files/double_driver_soln.png){width=60%}
...
![all_together](./Course_ Verilog Crash Course_files/all_together(2).png){width=100%}
