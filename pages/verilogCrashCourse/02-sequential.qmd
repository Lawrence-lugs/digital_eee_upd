...
![dff](./Course_ Verilog Crash Course_files/dff.png){width=30%}
...
![counter_updown_v2](./Course_ Verilog Crash Course_files/counter_updown.png){width=70%}
...
![combinational_loop](./Course_ Verilog Crash Course_files/combinational_loop(1).png){width=45%}
...
![](./Course_ Verilog Crash Course_files/dff_enable.png){width=45%}
...
![counter_updown_reset](./Course_ Verilog Crash Course_files/counter_updown_reset.png){width=70%}
...
![all_together](./Course_ Verilog Crash Course_files/all_together(3).png){width=100%}
