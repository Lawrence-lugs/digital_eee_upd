...
![initial](./Course_ Verilog Crash Course_files/initial (1).png){width=25%}
...
![testbench](./Course_ Verilog Crash Course_files/testbench.png){width=100%}
...
![simulation_draw](./Course_ Verilog Crash Course_files/simulation_draw (2).png){width=85%}
...
![simulation](./Course_ Verilog Crash Course_files/simulation (1).png){width=100%}
