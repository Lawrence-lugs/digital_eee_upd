...
![arithmetic_sub](./Course_ Verilog Crash Course_files/arithmetic_sub (1).png)

```
assign twice = a * 2;  // multiply by constant
```

![arithmetic_mult](./Course_ Verilog Crash Course_files/arithmetic_mult.png)
...
![bitwise_or](./Course_ Verilog Crash Course_files/bitwise_or (2).png)

```
assign xor_bits = a ^ b;  // bitwise XOR
```

![bitwise_xor](./Course_ Verilog Crash Course_files/bitwise_xor (2).png)

```
assign not_a    = ~a;     // bitwise NOT (inverts every bit)
```

![bitwise_not](./Course_ Verilog Crash Course_files/bitwise_not (2).png)
...
![shift_right](./Course_ Verilog Crash Course_files/shift_right (2).png)
...
![conditional](./Course_ Verilog Crash Course_files/conditional (1).png)
...
![all_together](./Course_ Verilog Crash Course_files/all_together(1).png)
