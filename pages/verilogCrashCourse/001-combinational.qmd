...
![assign](./Course_ Verilog Crash Course_files/assign_v2.png){width=55%}
...
![arithmetic_add](./Course_ Verilog Crash Course_files/arithmetic_add (1).png){width=40%}

```
assign diff = a - b;   // subtraction
```

![arithmetic_sub](./Course_ Verilog Crash Course_files/arithmetic_sub (1).png){width=40%}

```
assign twice = a * 2;  // multiply by constant
```

![arithmetic_mult](./Course_ Verilog Crash Course_files/arithmetic_mult.png){width=40%}
...
![bitwise_and](./Course_ Verilog Crash Course_files/bitwise_and (2).png){width=40%}

```
assign or_bits  = a | b;  // bitwise OR
```

![bitwise_or](./Course_ Verilog Crash Course_files/bitwise_or (2).png){width=40%}

```
assign xor_bits = a ^ b;  // bitwise XOR
```

![bitwise_xor](./Course_ Verilog Crash Course_files/bitwise_xor (2).png){width=40%}

```
assign not_a    = ~a;     // bitwise NOT (inverts every bit)
```

![bitwise_not](./Course_ Verilog Crash Course_files/bitwise_not (2).png){width=40%}
...
![shift_left](./Course_ Verilog Crash Course_files/shift_left (3).png){width=65%}

```
assign right_shift = a >> 2; // shifts right by 2 (like divide by 4); 0 padding, lower bit(s) truncated
```

![shift_right](./Course_ Verilog Crash Course_files/shift_right (2).png){width=65%}
...
![conditional](./Course_ Verilog Crash Course_files/conditional (1).png){width=38%}
...
![assignment_declaration](./Course_ Verilog Crash Course_files/assignment_declaration.png){width=55%}
...
![concat](./Course_ Verilog Crash Course_files/concat.png){width=60%}
...
![replication](./Course_ Verilog Crash Course_files/replication.png){width=75%}
...
![slice](./Course_ Verilog Crash Course_files/slice.png){width=55%}
...
![concurrency](./Course_ Verilog Crash Course_files/concurrency.png){width=45%}
...
![all_together](./Course_ Verilog Crash Course_files/all_together(1).png){width=100%}
